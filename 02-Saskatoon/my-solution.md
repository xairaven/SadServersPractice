```sh
admin@ip:/$ head -n5 /home/admin/access.log 
...
admin@ip:/$ awk '{print $1}' /home/admin/access.log | sort | uniq -c | sort -nr | head -n1 | awk '{print $2}' > /home/admin/highestip.txt

admin@ip:/$ sha1sum /home/admin/highestip.txt
